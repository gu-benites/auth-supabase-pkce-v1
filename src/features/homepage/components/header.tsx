...
import NavLink from './hero-header/nav-link';
import DropdownMenu from './hero-header/dropdown-menu';
import MobileMenu from './hero-header/mobile-menu';
import { MenuIcon, CloseIcon } from './hero-header/icons';
 ...
 * It includes the application logo, desktop navigation links, dropdown menus,
 * a mobile menu toggle, and authentication-related action buttons.
 * The header's appearance changes on scroll.
 * Authentication state (user, profile, loading status) is managed via the `useAuth` hook.
 *
